  ...
  return (
    <div className="pl-10 pt-20 p-8 bg-gray-50 min-h-screen text-gray-800">
      <div className="max-w-5xl mx-auto bg-white shadow-lg rounded-xl p-10">
        {/* Header */}
        <h1 className="text-4xl font-bold text-blue-600 mb-6">About UniBazzar</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-8">
          <div className="flex items-start space-x-4">
            ...
            <div>
              <h3 className="text-xl font-semibold text-gray-700 mb-1">Academic Marketplace</h3>
          ...
          <div className="flex items-start space-x-4">
            ...
            <div>
              <h3 className="text-xl font-semibold text-gray-700 mb-1">Tutoring & Services</h3>
              <p className="text-sm text-gray-600">
          ...
          <div className="flex items-start space-x-4">
            ...
            <div>
              <h3 className="text-xl font-semibold text-gray-700 mb-1">Local Commerce</h3>
              <p className="text-sm text-gray-600">
          ...
          <div className="flex items-start space-x-4">
            ...
            <div>
              <h3 className="text-xl font-semibold text-gray-700 mb-1">Campus Connections</h3>
              <p className="text-sm text-gray-600">
        ...
        <div className="mt-10 bg-blue-50 border border-blue-100 rounded-xl p-6 text-center">
          <h2 className="text-2xl font-bold text-blue-700 mb-2">Join the UniBazzar Community</h2>
